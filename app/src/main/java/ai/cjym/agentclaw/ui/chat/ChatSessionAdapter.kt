...
import ai.cjym.agentclaw.databinding.ItemChatSessionBinding
import ai.cjym.agentclaw.databinding.ItemChatSessionHeaderBinding
    ...
    class SessionHolder(
        ...
        fun bind(
            ...
            binding.actionButton.setImageResource(
                when (actionMode) {
                    SessionActionMode.DELETE_ALWAYS -> ai.cjym.agentclaw.R.drawable.ic_shell_delete
                    SessionActionMode.MORE_ON_SELECTED_HOVER -> ai.cjym.agentclaw.R.drawable.ic_shell_chat_more
                }
            )
            binding.actionButton.contentDescription = binding.root.context.getString(
                when (actionMode) {
                    SessionActionMode.DELETE_ALWAYS -> ai.cjym.agentclaw.R.string.chat_delete_confirm
                    SessionActionMode.MORE_ON_SELECTED_HOVER -> ai.cjym.agentclaw.R.string.chat_session_more
                }
            )
