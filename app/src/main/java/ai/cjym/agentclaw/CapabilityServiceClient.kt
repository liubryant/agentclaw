...
import ai.cjym.agentclaw.capability.ICapabilityService
...
class CapabilityServiceClient(private val context: Context) {
    ...
    companion object {
        private const val ACTION_BIND = "ai.cjym.agentclaw.capability.BIND"
        private const val SERVICE_PACKAGE = "ai.cjym.agentclaw.capability"
